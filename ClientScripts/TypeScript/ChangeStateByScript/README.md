...
1. Открыть консоль в папке ChangeStateByScriptWebExtension и выполнить команду npm install, потом  npm run build:prod
2. Скопировать каталог SamplesOutput\Site\Content\Modules\ChangeStateByScriptWebExtension в каталог "Путь к сайту Web-клиента\Content\Modules"
