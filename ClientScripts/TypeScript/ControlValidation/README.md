...
1. Открыть консоль в папке ControlValidationWebExtension и выполнить команду npm install, потом  npm run build:prod
2. Скопировать каталог SamplesOutput\Site\Content\Modules\ControlValidationWebExtension в каталог "Путь к сайту Web-клиента\Content\Modules"
