...
3. Скопировать каталог SamplesOutput\Site\Content\Extensions\ChangeLogoAndBackground в каталог "Путь к установленному Web-клиент\Site\Content\Extensions"
4. Перезапустить IIS
