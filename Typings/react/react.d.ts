...
declare namespace React {
    ...
    type FunctionalComponent<T> = (props: T) => ReactElement<any> | null;
    ...
    interface ClipboardEvent<T = any> extends SyntheticEvent<T> {
        clipboardData: DataTransfer;
        nativeEvent: NativeClipboardEvent;
    }

    interface CompositionEvent<T = any> extends SyntheticEvent<T> {
        data: string;
        nativeEvent: NativeCompositionEvent;
    }

    interface DragEvent<T = any> extends MouseEvent<T> {
        dataTransfer: DataTransfer;
        nativeEvent: NativeDragEvent;
    }

    interface FocusEvent<T = any> extends SyntheticEvent<T> {
    ...
    interface InvalidEvent<T = any> extends SyntheticEvent<T> {
    ...
    interface TouchEvent<T = any> extends SyntheticEvent<T> {
        altKey: boolean;
    ...
    interface UIEvent<T = any> extends SyntheticEvent<T> {
        detail: number;
        nativeEvent: NativeUIEvent;
        view: AbstractView;
    }

    interface WheelEvent<T = any> extends MouseEvent<T> {
        deltaMode: number;
        deltaX: number;
        deltaY: number;
        deltaZ: number;
    ...
    interface AnimationEvent<T = any> extends SyntheticEvent<T> {
    ...
    interface TransitionEvent<T = any> extends SyntheticEvent<T> {
        elapsedTime: number;
