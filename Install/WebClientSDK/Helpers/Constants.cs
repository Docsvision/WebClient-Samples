namespace WebClientSDK.Helpers
{
    class Constants
    {
        public const string UpgradeCode = "{24B94BB3-4107-4241-96B0-55718AD583DF}";

        public const string UpgradeCodeWebClient = "{BFE30173-C9ED-4AC1-AE3A-D787BC7CE1AE}";
        ...
        public const string ProductIcon = @"Images\Product.ico";
    }
}
