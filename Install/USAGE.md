...
- При запуске проверяется наличие всего необходимого программного обеспечения для разработки.
    ...
    - Если Node.js отсутствует, или его версия ниже требуемой, будет предложено установить Node 22.14.0 (LTS).
    - Если установлен Node Version Manager, и версия Node ниже требуемой. будет предложено установить Node 22.14.0 (если отсуствует) с последующим переключением на нее.
